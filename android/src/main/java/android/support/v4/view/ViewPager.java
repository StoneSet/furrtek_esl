...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (clientWidth < itemInfo.position) {
                ...
                i4 = 0;
                i2 = clientWidth + 1;
                while (i2 <= itemInfo.position && i4 < this.mItems.size()) {
                    itemInfo3 = (ItemInfo) this.mItems.get(i4);
                    while (i2 > itemInfo3.position && i4 < this.mItems.size() - 1) {
                        i4++;
                        itemInfo3 = (ItemInfo) this.mItems.get(i4);
                    }
                    i5 = i2;
                    ...
                    while (i6 < itemInfo3.position) {
                        pageWidth = (this.mAdapter.getPageWidth(i6) + f2) + f3;
                        i6++;
                        f3 = pageWidth;
                    }
                    itemInfo3.offset = f3;
                    f3 += itemInfo3.widthFactor + f2;
                    clientWidth = i6 + 1;
                    f = f3;
                    i2 = clientWidth;
                }
                ...
                f = itemInfo2.offset;
                i2 = clientWidth - 1;
                while (i2 >= itemInfo.position && i4 >= 0) {
                    itemInfo3 = (ItemInfo) this.mItems.get(i4);
                    while (i2 < itemInfo3.position && i4 > 0) {
                        i4--;
                        itemInfo3 = (ItemInfo) this.mItems.get(i4);
                    }
                    i5 = i2;
                    ...
                    i6 = i5;
                    while (i6 > itemInfo3.position) {
                        pageWidth = f3 - (this.mAdapter.getPageWidth(i6) + f2);
                        i6--;
                        f3 = pageWidth;
                    }
                    f3 -= itemInfo3.widthFactor + f2;
        ...
        f = f2 + (itemInfo.offset + itemInfo.widthFactor);
        i2 = itemInfo.position + 1;
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            if (obj == null && scrollX < f2) {
                break;
            } else if (scrollX < f4 || i3 == this.mItems.size() - 1) {
                return itemInfo2;
            } else {
                int i4 = i3 + 1;
                f3 = f2;
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == 1 && this.mAdapter != null && this.mAdapter.getCount() > 1)) {
            ...
            if (!this.mRightEdge.isFinished()) {
                ...
                canvas.rotate(90.0f);
                canvas.translate((float) (-getPaddingTop()), (-(1.0f + this.mLastOffset)) * ((float) width));
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (i4 < i2) {
                ...
                if (((float) this.mPageMargin) + f3 > ((float) scrollX)) {
                    this.mMarginDrawable.setBounds((int) f3, this.mTopPageBounds, (int) (0.5f + (((float) this.mPageMargin) + f3)), this.mBottomPageBounds);
    ...
    protected void onPageScrolled(int i, float f, int i2) {
            ...
            while (i3 < childCount) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    switch (layoutParams.gravity & 7) {
                        ...
                        case 3:
                            i5 = paddingRight;
                            paddingRight = childAt.getWidth() + paddingLeft;
                            i4 = i5;
                            break;
                        case 5:
        ...
        if (this.mPageTransformer != null) {
            ...
            i3 = getChildCount();
            for (paddingRight = 0; paddingRight < i3; paddingRight++) {
                View childAt2 = getChildAt(paddingRight);
                if (!((LayoutParams) childAt2.getLayoutParams()).isDecor) {
                    this.mPageTransformer.transformPage(childAt2, ((float) (childAt2.getLeft() - paddingLeft)) / ((float) getClientWidth()));
                }
            }
        }
    ...
    void populate(int i) {
        ...
        if (this.mAdapter == null) {
            ...
            ItemInfo addNewItem = (itemInfo != null || count <= 0) ? itemInfo : addNewItem(this.mCurItem, i4);
            if (addNewItem != null) {
                int i5 = i4 - 1;
                itemInfo = i5 >= 0 ? (ItemInfo) this.mItems.get(i5) : null;
                int clientWidth = getClientWidth();
                ...
                while (i6 >= 0) {
                    if (f < paddingLeft || i6 >= max) {
                        if (itemInfo == null || i6 != itemInfo.position) {
                            f += addNewItem(i6, i4 + 1).widthFactor;
                            i5++;
                            itemInfo = i4 >= 0 ? (ItemInfo) this.mItems.get(i4) : null;
                        } else {
                        ...
                        break;
                    } else if (i6 == itemInfo.position && !itemInfo.scrolling) {
                        this.mItems.remove(i4);
                        this.mAdapter.destroyItem((ViewGroup) this, i6, itemInfo.object);
                        i4--;
                        i5--;
                        itemInfo = i4 >= 0 ? (ItemInfo) this.mItems.get(i4) : null;
                    }
                ...
                int i8 = i5 + 1;
                if (f2 < 2.0f) {
                    itemInfo2 = i8 < this.mItems.size() ? (ItemInfo) this.mItems.get(i8) : null;
                    ...
                    i6 = this.mCurItem + 1;
                    while (i6 < count) {
                        if (f < paddingRight || i6 <= min) {
                            if (itemInfo == null || i6 != itemInfo.position) {
                                itemInfo = addNewItem(i6, i9);
                                i9++;
                                f += itemInfo.widthFactor;
                                itemInfo = i9 < this.mItems.size() ? (ItemInfo) this.mItems.get(i9) : null;
                            } else {
                                f += itemInfo.widthFactor;
                                i9++;
                                itemInfo = i9 < this.mItems.size() ? (ItemInfo) this.mItems.get(i9) : null;
                ...
                calculatePageOffsets(addNewItem, i5, infoForPosition);
            }
            ...
            for (int i10 = 0; i10 < i4; i10++) {
                ...
                if (!layoutParams.isDecor && layoutParams.widthFactor == 0.0f) {
                    itemInfo2 = infoForChild(childAt);
                    if (itemInfo2 != null) {
            ...
            if (hasFocus()) {
                View findFocus = findFocus();
                itemInfo = findFocus != null ? infoForAnyChild(findFocus) : null;
                if (itemInfo == null || itemInfo.position != this.mCurItem) {
                    i3 = 0;
                    while (i3 < getChildCount()) {
                        View childAt2 = getChildAt(i3);
                        ItemInfo infoForChild = infoForChild(childAt2);
                        if (infoForChild == null || infoForChild.position != this.mCurItem || !childAt2.requestFocus(r4)) {
                            i3++;
                        } else {
                            return;
                        }
